...
```
git remote add academy git@github.com:ev-emelyanov/lapink.git
```
...
`lesson-1` — это название ветки. Под описанием каждого задания в интерфейсе интенсива для вас будет указано правильное название ветки.
